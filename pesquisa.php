...
//$connect = mysqli_connect('localhost','root','','sitemls');

// conectar banco de Prod
$connect = mysqli_connect('localhost','id1952072_marcelo','Mls123','id1952072_sitemls');
...
<head>
    ...
    <meta name="author" content="Marcelo Leopoldino dos Santos">

    <title>Site MLS - Pesquisa Contato</title>
...
<body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Marcelo Leopoldino</a>
            </div>
    ...
    <div class="container">
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p>Copyright &copy; MLS Site 2017 - Introdução a Desenvolvimento WEB/Fatec Carapicuiba</p>
                </div>
            </div>
        </footer>
